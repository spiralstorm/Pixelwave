...
#ifndef _PX_TOP_LEVEL_H_
#define _PX_TOP_LEVEL_H_
...
/// Returns the time in seconds since the Pixelwave framework was initialized
double PXGetTimerSec();

/// Returns the time in milliseconds since the Pixelwave framework was
/// initialized
long PXGetTimer();
/// @}
