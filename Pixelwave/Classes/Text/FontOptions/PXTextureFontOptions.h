...
@interface PXTextureFontOptions : PXFontOptions <NSCopying, PXPooledObject>
{
@protected
	float size;

	id<PXTextureModifier> textureModifier;
}
...
/**
 * The font size to be used to create the texture font generated by these
 * options.
 *
 * **Default:** 12.0f
 */
