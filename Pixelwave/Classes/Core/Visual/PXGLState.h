...
#ifndef _PX_GL_STATE_H_
#define _PX_GL_STATE_H_
...
// NOTE:
//		The state is reset to your default, and upon a PXGLDrawArrays or
//		PXGLDrawElements call it compares the states. If they are different then
