...
@interface PXSoundLoader : PXLoader
{
@protected
	PXSoundParser *soundParser;
}
...
//-- ScriptName: SoundLoader
//-- ScriptArg[0]: required
//-- ScriptArg[1]: nil
- (id) initWithContentsOfFile:(NSString *)path modifier:(id<PXSoundModifier>)modifier;
//-- ScriptName: SoundLoaderWithContentsOfURL
//-- ScriptArg[0]: required
//-- ScriptArg[1]: nil
- (id) initWithContentsOfURL:(NSURL *)url modifier:(id<PXSoundModifier>)modifier;
