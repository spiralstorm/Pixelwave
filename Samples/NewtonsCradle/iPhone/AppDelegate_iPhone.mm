...
- (BOOL) application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	pixelView = [[PXView alloc] initWithFrame:window.frame colorQuality:PXViewColorQuality_High];
	// Set some basic settings
	pixelView.stage.backgroundColor = 0x808080;
	pixelView.stage.frameRate = 60;
	pixelView.multipleTouchEnabled = YES;

	// Create an instance of NewtonsCradleRoot and set it as
	// the new root of the main display list.
	NewtonsCradleRoot *root = [[NewtonsCradleRoot alloc] init];
