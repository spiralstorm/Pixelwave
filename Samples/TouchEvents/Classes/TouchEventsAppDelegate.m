...
#import "Pixelwave.h"
#import "TouchEventsAppDelegate.h"
#import "TouchEventsRoot.h"

@implementation TouchEventsAppDelegate
...
- (void) applicationDidFinishLaunching:(UIApplication *)application
{
	...
	//pixelView.stage.backgroundColor = 0xFFFFFF;

	// We want quicker response for our test!
	pixelView.stage.frameRate = 60;
	pixelView.stage.renderFrameRate = 60;

	// Create an instance of TouchEventsRoot and set it as the new Root.
	TouchEventsRoot *root = [[TouchEventsRoot alloc] init];
