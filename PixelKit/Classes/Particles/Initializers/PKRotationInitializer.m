...
@implementation PKRotationInitializer
...
{
	float rotation = PKRangeRandom(range);
...
+ (PKRotationInitializer *)rotationInitializerWithRange:(PKRange)range
{
	return [[[PKRotationInitializer alloc] initWithRange:range] autorelease];
}
