...
#import "PXStage.h"
/**
 * The base class for all particle flows in PixelKit.
 */
@implementation PKParticleFlowBase
...
- (unsigned int) startWithEmitter:(PKParticleEmitter *)emitter
{
	...
	//return [self updateWithEmitter:emitter deltaTime:1.0f / [PXStage mainStage].frameRate];
	return 0;
}
