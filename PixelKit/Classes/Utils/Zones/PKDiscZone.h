...
@interface PKDiscZone : NSObject <PKZone>
{
@protected
	CGPoint center;
...
- (id) initWithCenter:(CGPoint)center outerRadius:(float)outerRadius innerRadius:(float)innerRadius;
- (id) initWithOuterRadius:(float)outerRadius innerRadius:(float)innerRadius;
- (id) initWithOuterRadius:(float)outerRadius;
