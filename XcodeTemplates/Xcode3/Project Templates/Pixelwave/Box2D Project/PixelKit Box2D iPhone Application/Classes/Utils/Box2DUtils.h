...
//  Box2DTest
//
//  Created by Oz Michaeli on 12/29/10.
...
// Roughly 9.8 m/(s^2)
#define GRAVITY 9.8f
// 163 ppi = 64.1732283 points per cm = 6417.32283 points per meter
// However, Box2D does not handle small objects well, so we are going to make
// them 100x their normal size.
